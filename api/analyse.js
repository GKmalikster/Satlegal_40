...
76. ONLINE TRADING APP / INVESTMENT FRAUD TELEGRAM GROUP / LOAN APP MISUSE / NET BANKING HACKED / CRYPTO EXCHANGE NOT RETURNING FUNDS / HACKER TRANSFERRED MONEY → "Cyber – Online Fraud / Financial Cyber Crime". NOT BNS Fraud (BNS Fraud is for offline cheating; Cyber Online Fraud covers all digital/financial cybercrime).
77. WIDOW RIGHTS IN PROPERTY / GRANDFATHER DIED WHO INHERITS / ADOPTED CHILD RIGHTS / MARRIED DAUGHTER PROPERTY RIGHTS AFTER 2005 / PROPERTY OF UNMARRIED PERSON → "Property – Hindu Succession / Inheritance Dispute". NOT Murder (widow/property queries are about succession, not death by violence).
78. NRI PASSPORT RENEWAL / CONSULATE DISPUTE / FOREIGN COURT DIVORCE VALID IN INDIA / NRI FACING CRIMINAL COMPLAINT / NRI BEING HARASSED BY RELATIVES → "NRI – Property / Family / Legal Issues (Non-Resident Indian)".
79. DEFAMATION / NEWSPAPER FALSE REPORT / NEWS CHANNEL FALSE ALLEGATIONS / SOCIAL MEDIA FALSELY CALLING ME CRIMINAL / FORMER EMPLOYEE DEFAMING COMPANY → "Civil/Criminal – Defamation / False Statements / Reputation Damage".
80. YOUTUBE USING MY COPYRIGHTED CONTENT / DOMAIN NAME CYBERSQUATTING / STARTUP NAME TRADEMARKED / PAINTING SOLD WITHOUT PERMISSION / SOFTWARE CODE COPIED → "Intellectual Property – Trademark / Copyright / Patent Dispute". NOT Cyber.
...
- BNS (Mischief / Property Damage / Vandalism): Someone INTENTIONALLY DAMAGED PROPERTY — smashed a car window, broke a gate, vandalized a vehicle, threw stones at property. No theft occurred (nothing was taken). Keywords: smashed, window broken, vandalized, car damaged, property destroyed intentionally. NOT Fraud (Fraud is deception for money). NOT Assault (Assault is injury to a person, not property).
- DO NOT default all BNS matters to Theft/Robbery. A HOSPITAL DEATH is Medical Negligence (BNS 106). A SEXUAL ASSAULT is Rape (BNS 64-70). A NON-MEDICAL intentional killing is Murder. A financial scam is FRAUD. A non-sexual beating (victim alive) is ASSAULT. Only actual taking of goods is THEFT. Property deliberately damaged (but not taken) is MISCHIEF.

90. JEWELLERY PURITY / GOLD KARAT / FAKE JEWELLERY / HALLMARK FRAUD / BIS STAMP / JEWELLERY QUALITY COMPLAINT → "Consumer – Product Defect / Service Deficiency" as primary. Add "Criminal – BNS (Fraud / Cheating)" if the jeweller actively misrepresented purity. NEVER "Family – Dowry / 498A / Streedhan Recovery" or "Family – Domestic Violence" — gold jewellery in a consumer purchase context is NOT dowry. Dowry/498A only applies when the jewellery was explicitly described as dowry demanded in a marriage.
91. CAR WINDOW SMASHED / VEHICLE VANDALIZED / PROPERTY DAMAGED INTENTIONALLY / WINDOW BROKEN BY SOMEONE / CAR SCRATCHED ON PURPOSE → "Criminal – BNS (Mischief / Property Damage / Vandalism)". NOT "Criminal – BNS (Fraud / Cheating)" — property damage without theft or deception is mischief, not fraud.
92. SHOPKEEPER HARASSING / SELLER MISBEHAVING / STORE REFUSING TO HELP / COMPANY THREATENING AFTER COMPLAINT / OFFLINE BUSINESS HARASSMENT → "Consumer – Product Defect / Service Deficiency". "Cyber – Online Harassment / Cyberstalking / Defamation" is ONLY for online stalking, threats via internet/WhatsApp, revenge porn, doxxing — NOT for in-person harassment by a shopkeeper or refusal of service.
