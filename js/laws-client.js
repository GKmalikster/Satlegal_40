...
const LAWS_DATABASE = [
  ...
  // HINDU MARRIAGE ACT & DIVORCE
  {
    ...
    keywords: {
      ...
      strong: ['divorce','separation','cruelty','adultery','desertion','impotency','mental cruelty','physical cruelty','matrimonial home','marital discord','broken marriage','failed marriage','petition','respondent spouse','matrimonial','conjugal rights','husband abusive','wife abusive','domestic violence','dowry harassment','bigamy','annulment','void marriage','voidable marriage','irretrievable breakdown','convert religion marriage',
        'married another woman','married another man','husband married another','wife married another','second wife','second husband','married while still married','married without divorcing','remarried without divorce','husband remarried','wife remarried','divorced me without informing','drug addict husband','alcoholic husband','want to leave him','leave my husband','leave my wife'],
...

  {
    ...
    keywords: {
      ...
      strong: ['custody','child custody','children custody','guardianship','minor child','visitation','visitation rights','access rights','parenting plan','child welfare','best interests of child','physical custody','legal custody','primary caregiver','custody order','custody petition','ward','guardian','children abroad','taken abroad without','international child custody','child overseas','hague convention custody',
        'child wants to live with me','child wants to stay with me','court order child stays','took child to another city','wife took child','husband took child','child abduction parental','parental child abduction','took my daughter to another','took my son to another','child taken without permission','relocation with child','child relocation objection','ex wife wants to take','ex husband wants to take','permanently relocate child abroad'],
...

  {
    ...
    keywords: {
      ...
      weak: ['money','support','husband','wife','children','financial','monthly','not giving','refusing','separated','abandoned',
        // Hindi maintenance keywords
        'guzara bhatta','nafaqa','nafqa','bhatta nahi','pati nahi deta','pati de raha','pati nahi de raha','guzara nahi de raha','kharcha nahi deta','kharcha nahi de raha','pati ka kharcha','bacchon ka kharcha','court se kharcha','maintenance de raha nahi','guzara bhatta nahi']
    },
...

  {
    ...
    keywords: {
      exact: ['husband beating me','physical violence by husband','domestic violence complaint','abused by husband','husband threatening to kill','in-laws harassing','protection order against husband','thrown out of home by husband','mental torture by in-laws','dowry demand','dowry harassment','dowry torture','498a','section 498a','498 a','498-a','pwdva complaint','dv act complaint','domestic violence act','sec 498','husband hits me','husband beats me','pati maar raha hai','live-in partner is abusive dv act','does dv act apply to live-in','live-in relationship abusive domestic violence','residence order under dv act','leave the matrimonial home dv act','dv act to stay in shared house','residence order dv act matrimonial home',
        'husband threw me out','threw me out of the house','my husband threw me out','husband threw me out of the house','threw me out of matrimonial home','threw me out of house','want court order to stay','court order to stay in matrimonial home','stay in matrimonial home husband threw','thrown out of matrimonial home want to return','want to go back to matrimonial home','i want to go back home husband',
        // Economic abuse
        'husband gives me no money','husband controls all finances','no money for household expenses','husband withholds money','husband controls expenses','financial control by husband','husband refuses money for food','economically abused by husband',
        // Emotional / psychological abuse
        'husband constantly threatens to divorce','threatens to take kids away','husband threatens divorce','mentally tortured by husband','emotional torture husband','husband insults me daily','husband belittles me','husband humiliates me','husband controls my movements','husband isolates me',
        // DV act urgent
        'immediate relief under DV act','immediate DV act relief','DV act today','urgent DV protection','DV act protection today',
        // Live-in / colleague
        'live-in partner abusing','live-in partner is abusive','colleague abusing me','partner colleague abuse','my partner abuses me'],
      strong: ['domestic violence','physical abuse','mental abuse','emotional abuse','dowry','harassment','threatened','violence at home','beaten','assault','shelter home','protection order','restraining order','in-laws','father-in-law','mother-in-law','marital rape','economic abuse','isolation','controlling behaviour','stridhan','jewellery taken','residence order','dv case','cruelty by husband','thrown out by husband',
        'DV act','DV act relief','protection under DV','domestic violence relief','abusive partner','abusive spouse','abusive husband','abused by partner','abused at home','husband withholds','economic deprivation','financial abuse','husband threatens divorce','husband threatened to kill','in-laws threatened'],
      weak: ['abuse','violence','hurt','fear','safe','scared','beaten','in-laws','home','threat','dowry','unsafe','maar','peet','maar raha','darr','dara','peeta','DV act','DV relief','domestic violence','abused at home','husband abusive']
    },
  ...
  // SUCCESSION LAWS
  {
    ...
    keywords: {
      ...
      strong: ['father died','mother died','husband died','parent died','passed away','no will','without will','died without','ancestral property','ancestral land','grandfather property','grandmother property','family property','joint family','inherited property','huf','hindu undivided family','coparcener','daughter share','daughter rights','legal heir','legal heirs','property distribution','property division after death','share in property','succession','inherit','inheritance','intestate','class i heir','brothers denying','relatives claiming','vineeta sharma','hisse ki zameen','maa ki death ke baad bhai','bhai zameen nahi de','mere hisse ki zameen','baap ki zameen bhai nahi de','zameen hissa nahi','maa ke baad zameen','bhai mere hisse ki zameen','zameen share nahi de raha',
        'deceased father bank balance','claim deceased father','claim deceased husband','widow property rights','widow rights in property','in-laws say no right','in-laws denying property','deceased husband property','husband passed away property','wife after husband death property','claim bank balance of deceased','succession certificate for bank','succession certificate bank account','claim dead husband bank','assets of deceased'],
...

  {
    ...
    keywords: {
      ...
      strong: ['his will','her will','my will','a will','the will','father will','mother will','made a will','left a will','execute a will','probate','executor','testator','bequest','contested will','challenge will','letters of administration','succession certificate','legal heir','disputed will','codicil','testamentary','intestate succession','grant of probate','undue influence','mental capacity','signature on will','vasiyat','family settlement','settlement among heirs','heirs dispute settlement','oral will','verbal will','partial will','deceased left will','told everyone before death','said before death gives property','is oral will valid','verbal will valid','remaining assets disputed','deceased left partial will'],
  ...
  // IT ACT / CYBER FRAUDS
  {
    ...
    keywords: {
      ...
      strong: ['cyber fraud','online fraud','internet fraud','digital fraud','phishing','upi','bank hacked','account hacked','otp shared','scam','fake website','impersonation','identity theft','cloned card','card skimming','account drained','money stolen online','cybercrime','cyber police','national cyber crime helpline','freeze account','beneficiary fraud','transaction fraud','voice cloning fraud','deepfake fraud','it act 66c','it act 66d','section 66c','section 66d','1930 helpline','matrimonial fraud','fake loan app','digital arrest','courier fraud','travel fraud online','fake call payment','fake agent fraud',
        // SIM swap / CEO fraud / gaming
        'sim swap','sim swapped','sim cloned','sim card fraud','my sim was swapped','phone sim swapped','SIM fraudulently','bank account drained after sim',
        'ceo fraud','business email compromise','impersonating ceo','ceo impersonation email','cfo transfer fraud','wire transfer fraud email',
        'online gaming fraud','gaming platform fraud','defrauded in gaming','online game cheated','gaming scam',
        'digital signature fraud','digital signature misused','digital signature used fraudulently','forged digital signature',
        'job consultancy fraud','fake job consultancy','paid for job placement fake','fake placement agency','job scam online'],
      weak: ['cheated','fraud','scam','stolen','lost money','online','internet','digital','bank','money','transfer','hack','paise gaye','thagi','nakli','fake call','sim','ceo','gaming','digital signature','job scam','placement fraud',
        // Hindi OTP/bank fraud
        'OTP lekar','OTP le liya','OTP bataya paise gaye','bank adhikari bataaya','bank officer batakar','phon karke bank','phone karke paise','khate se paise nikaal','account se paise gaye','paise nikal liye','fraud call aaya','fake bank call','bank ka naam lekar']
    },
...

  {
    ...
    keywords: {
      ...
      'deepfake video of me circulating online','deepfake video of me','deepfake video circulating','edited screenshot of my conversation being circulated','edited screenshot circulated defaming','edited screenshot being circulated','screenshot of my conversation being circulated defaming','screenshot circulated to defame','screenshot being circulated defaming me','morphed screenshot circulated','edited screenshot defaming',
      ...
      strong: ['cyberstalking','online harassment','cyber harassment','digital harassment','social media harassment','fake profile','impersonation online','defamation online','morphed images','intimate images','revenge porn','non-consensual sharing','obscene content','threatening messages online','bullying online','trolling','doxing','rape threat','death threat online','anonymous threatening messages','blackmail online','threats twitter','threatening account','edited screenshot defamation','morphed screenshot','screenshot circulating to defame','edited screenshot being circulated','screenshot defamation','fake screenshot defaming me',
        // Private photo / revenge porn phrasings
        'private photos online','private photos shared without consent','private photos posted','photos posted without consent','photos shared without consent','ex posted photos','ex boyfriend posted','ex girlfriend posted','posted my photos','posted intimate photos','leaked my photos','private video leaked','nude photos shared','objectionable photos shared','private images posted','pictures shared without consent',
        // Instagram / social media continuous harassment
        'messaging me on instagram','messaging me on whatsapp','harassing me on instagram','harassing me on facebook','harassing me on whatsapp','harassing me online','continuously messaging','keeps messaging','messaging despite blocking','blocked but still messaging','blocked and still messaging','messages after blocking','harassing despite blocking','stalking me online','following me online','tracking me online','keeps tracking','continuously following',
        // Defamation reputation
        'false review about me','fake review about my business','spreading lies about me','spreading false information','character assassination','reputation damage online','online reputation destroyed','name being maligned'],
      weak: ['harassed','stalked','threatened','defamed','fake','images','social media','online','photos','messages','threatening','instagram','whatsapp','facebook','twitter','youtube','blocking','blocked','private','ex-boyfriend','ex-girlfriend','ex boyfriend','ex girlfriend','leaked','nude','intimate','obscene','morphed']
    },
...

  {
    ...
    keywords: {
      ...
      strong: ['hacking','hacked','data breach','data theft','ransomware','malware','corporate espionage','unauthorized access','computer crime','data leaked','trade secret','confidential info stolen','password hacked','network intrusion','cyber attack business',
        'employee copied data','employee stole data','employee copied customer data','copied all data','took company data','stole customer data','data stolen by employee','ex-employee data theft','former employee data','employee took data before leaving','employee data stolen before leaving','customer data stolen','database copied','confidential data copied','client data stolen','client list stolen','company secrets taken','copied our database','employee misused data'],
      weak: ['stolen','hacked','breach','data','server','system','access','leaked','compromised','attack','intrusion','copied','employee copied','customer data','confidential','trade secret']
    },
  ...
  // BNS / BNSS – CRIMINAL
  {
    ...
    keywords: {
      ...
      strong: ['cheating','fraud','deceived','misrepresentation','false promise','dishonest','took money','sold as brand new','sold car claiming brand new','sold me car claiming new','sold me a car claiming it was brand new','claiming it was brand new accident car','repainted accident car sold','accident car sold as brand new','repainted accident car claiming new','sold vehicle claiming new','claimed brand new but accident','fraudulently sold vehicle','no delivery','fake documents','forged signature','dishonoured cheque','ni act','matri­monial fraud','investment fraud','multi-level marketing fraud','pyramid scheme','real estate fraud','job fraud','advance fee fraud','cheating by impersonation','cheque bounce','bounced cheque',
        // contractor / advance fraud
        'contractor took advance','contractor disappeared','advance taken disappeared','took advance and disappeared','took advance money','advance money taken','advance paid no work','paid advance no work','contractor vanished','contractor absconded','contractor cheated','advance for construction','construction advance fraud',
        // investment / chit fund
        'fake investment scheme','chit fund fraud','ponzi scheme','MLM fraud','multi level marketing','pyramid scam','investment scheme fraud','fake returns promised','promised high returns','high return investment fraud',
        // matrimonial / bigamy fraud
        'matrimonial fraud','groom cheated','bride cheated','marriage fraud','fake marriage','fake profile matrimony','matrimonial site cheated','misrepresented on matrimony','bigamy','already married and married again','concealed previous marriage','hidden previous marriage','hid previous marriage','second marriage without divorce','married when already married','suppressed previous marriage','married twice','first wife still alive married again',
        // broker / agent fraud
        'broker took commission','agent cheated','broker cheated','agent fraud','insurance agent fraud','travel agent fraud',
        // general
        'broker took money','supplier took money','vendor took money disappeared','service provider took money','money taken no service'],
      weak: ['cheated','lied','fraud','scam','money taken','not returned','promise broken','fake','forged','dishonest','deceit','thagi','dhoka','nakli','jhoota','paisa liya','advance','contractor','disappeared','vanished','absconded','investment','broker','agent','scheme','ponzi']
    },
...

  {
    ...
    keywords: {
      exact: ['physically assaulted','beaten up badly','grievous hurt','acid attack','stabbed','knife attack','gang attack','mob lynching','road rage attack','hit and run assault','communal violence','section 323','assault complaint',
        'beat up my','beat up a','watchman beat','guard beat','beat my family','broke his arm','broke her arm','broke my arm','someone punched','someone slapped','broken bone assault','bone fractured in fight','eve teasing','boys teasing girl','molestation on road','passed remarks at women','passed comments on girl','teasing my daughter','teasing my sister',
        'kidnapped my','abducted my','ransom demanded','my son was kidnapped','my daughter was kidnapped','abducted for ransom','held hostage','held for ransom','broke into my house','house break-in','broke into my home','entered my house forcibly','home invasion','intruder entered','someone entered at night','burglary','robbery at home','thief entered','stole from my house','broke in and stole'],
      strong: ['assault','beaten','attacked','hurt','injury','grievous hurt','bodily harm','physical attack','violence','battered','acid','burn','stabbed','shot','threat of violence','grievous fracture',
        'beat up','beat my','slapped','punched','kicked','thrashed','manhandled','roughed up','physically harmed','physical violence','broke arm','broke leg','fractured','eve teasing','teasing','molestation','ransom','kidnap','abduct','hostage','house break','broke into','burglary','robbery','intruder','home invasion'],
      weak: ['attacked','hit','hurt','injured','pain','hospital','medical','police complaint','fir','assault','fight','altercation','beat','slap','punch','kick','broke','fracture','teasing','kidnap','abduct','ransom','burglary','robbery','intruder','stole']
    },
  ...
  // TRANSFER OF PROPERTY ACT
  {
    ...
    keywords: {
      ...
      strong: ['sale deed','transfer of property','registration','property fraud','power of attorney','gift deed','property dispute','title deed','conveyance deed','possession not given','money paid property not transferred','property agreement','sale agreement','token money dispute','specific performance','agreement to sell','seller defaulting','mutation','mutation record','revenue mutation','bona fide purchaser','registration mutation',
        'mutated my property','mutation in their name','mutated in someone name','property mutated wrongly','mutation using forged','mutation using fake','forged mutation','fraudulent mutation','property in their name using forged','forged documents property transfer','property transferred using forged','sale deed forged','title deed forged','forged sale deed','cancel fraudulent sale deed'],
  ...
  // PROPERTY
  {
    ...
    keywords: {
      exact: ['neighbour encroached','neighbour built wall on my land','illegal construction on my land','boundary dispute with neighbour','encroachment on my property','land grabbing','neighbour crossed boundary','boundary wall dispute','neighbour blocking my access road claiming path','blocking access road claiming path belongs','access road blocked by neighbour claiming','my neighbor is blocking my access road','neighbor is blocking access road','blocking my access road claiming','neighbor blocking access road claiming his property','access road blocked by neighbor claiming property','municipality trying to demolish part of my house','neighbor occupying common passage between our houses','common passage occupied neighbor survey','vendor occupying footpath in front of my shop bmc','commercial vendor footpath encroachment shop','padosi ne deewar bana li','padosi ne plot mein deewar','padosi ne meri zameen le li','padosi boundary dispute','plot mein deewar bana di','neighbour ne meri zameen li','demolish part of my house','demolish my house claiming road','house on road widening alignment','claiming house on road widening','house claiming road alignment','municipality demolish house road','demolish house road widening','my house is on road widening','neighbor broke my wall','neighbour broke my wall','neighbor damaged my wall','neighbour damaged my wall','neighbor destroyed my wall','neighbor broke my fence','neighbor damaged my property','neighbour damaged my property','neighbor broke into my house','neighbor demolished my wall','neighbor broke down my wall','next door neighbor damaged','neighbor caused damage to my property','neighbor broke our common wall','neighbor has damaged','neighbor destroyed my property'],
      strong: ['encroachment','encroached','boundary','boundary wall','neighbour dispute','trespassing','illegal construction','unauthorized construction','wall on my property','land grabbing','occupied my land','my land taken','disputed land','survey report','mutation','neighbour','boundary stone','padosi','deewar bana li','plot mein deewar','padosi vivad','neighbor broke','neighbour broke','broke my wall','broke my fence','damaged my wall','damaged my property','neighbor damage','neighbor destroyed','property damage by neighbor','property damage by neighbour','broke down my wall','demolished my wall','property vandalism','damage to property','destruction of property','willful damage','mischief property','land survey wrongly measured','revenue department survey wrongly measured','revenue department survey shows','land wrongly measured by revenue','land has been wrongly measured','wrongly measured land','survey wrongly measured','land measurement wrong','survey shows wrongly measured','right to light','blocking sunlight','blocking all light','blocking ventilation','neighbor blocking light','tall building blocking light','blocking all light and ventilation','neighbor built tall building blocking','right to light blocked'],
      weak: ['wall','construction','fence','property line','plot','land','neighbour','neighbor','dispute','my land','my property','adjacent','next door','boundary','broke','damaged','destroyed','vandal']
    },
  ...
  // CIVIL
  {
    ...
    keywords: {
      ...
      weak: ['money','loan','borrowed','lent','owe','debt','repay','default','not returned','recover','due','unpaid loan','money owed',
        'client owes','owes me','my client owes','services not paid','project fees not paid','completed project not paid','brother took money','relative took money','friend took money','person took money','took money not returning','not returning money','not refunding money']
    },
  ...
  // CHEQUE BOUNCE (standalone – high volume in India)
  {
    ...
    keywords: {
      ...
      strong: ['cheque bounce','bounced cheque','cheque bounced','cheque has bounced','which bounced','cheque not cleared','dishonoured','insufficient funds','account closed','payment stopped','return memo','cheque return','legal notice 30 days','cheque complaint','138 notice','negotiable instrument','drawer','drawee','payee','cheque recovery','criminal complaint cheque','post-dated cheque','post dated cheque','pdc','ecs bounce','nach bounce','mandate bounce','cheque issued for loan','section 138','ni act 138','cheque return memo','demand notice cheque',
        'post dated cheques bounced','multiple cheques bounced','all cheques bounced','tenant cheques bounced','cheques from tenant bounced','supplier cheque bounced','5 cheques bounced','cheques bounced from','supplier gave me cheque'],
  ...
  // PIL / WRIT PETITIONS
  {
    ...
    keywords: {
      ...
      strong: ['pil','public interest litigation','writ','habeas corpus','mandamus','certiorari','prohibition','quo warranto','fundamental rights','article 21','article 14','article 19','article 32','article 226','high court writ','supreme court','constitutional remedy','state action illegal','government inaction','violation of rights','arbitrary order','mala fide','natural justice','audi alteram partem',
        // systemic / public interest failures
        'government hospital no doctors','hospital shortage','public hospital no staff','state hospital no doctors','state hospital has no doctors','state hospital no staff','hospital has no doctors','hospital no doctors months','ration card pending','ration card denied','ration card application has been pending','ration card application pending','government scheme pending','government scheme not processed','no doctors in village','village hospital closed','public healthcare failure','healthcare system failure','government not providing','state failure','systemic violation','mass violation','affecting thousands','affecting hundreds','affecting entire village','public health hazard','state hospital no doctors','state hospital no staff','ration card pending','ration card denied','ration card application pending','government scheme benefit denied','government benefit not given','government scheme pending','state hospital no doctors','state hospital no staff','ration card denied','ration card pending','ration card application pending','ration card pending 2 years','government scheme pending','government benefit denied','government benefit not given','benefit application pending','vote rigging','election rigging','electoral fraud','election manipulation','election challenge','election petition',
        // writ triggers
        'challenge government order','challenge arbitrary order','challenge government decision','government not implementing','government ignoring court order','challenge unconstitutional','challenge illegal government'],
  ...
  // NRI / OVERSEAS INDIAN LAWS
  {
    ...
    keywords: {
      ...
      strong: ['nri','non resident indian','oci card','oci holder','overseas citizen of india','overseas citizen','fema','foreign exchange','nre account','nro account','remittance india','property india nri','nri divorce','nri custody','nri maintenance','nri fraud','relative grabbed property','poa misused','power of attorney abuse','nri legal notice india','hague convention','child taken abroad','parental child abduction','international custody','overseas indian','overseas indian inheritance','while i am abroad','relatives claiming property','property grabbed while abroad','living abroad property','inheritance claim abroad','property dispute from abroad','living in usa','living in us','living in america','living in canada','relatives grabbed property','relatives have grabbed my property','relatives grabbed my india property','settled in usa property india','living abroad property grabbed','relatives grabbed while i was abroad'],
  ...
  // INTELLECTUAL PROPERTY
  {
    ...
    keywords: {
      ...
      strong: ['trademark','copyright','patent','intellectual property','ip infringement','brand name','logo','trade dress','counterfeit','piracy','plagiarism','design registration','geographical indication','passing off','trade secret','confidential information','ndas','licensing','royalty','infringement notice','cease and desist','ip court','dipp','ipab','design','infringement','deceptively similar','substantial similarity','registered trademark','patent claim','john doe order',
        'copied my blog','copied my entire blog','my blog content','blog content copied','website copied my content','copied blog content without permission','my content copied without','my music composition copied','music composition copied','original music copied','music copied in film','composition copied without credit','film copied my music','original composition copied','music used without credit','my song copied','my music used without permission','author name removed from published','name as author removed','name removed from published work','ip assignment agreement','startup ip agreement','co-founder ip agreement','intellectual property assignment startup'],
  ...
  // MUSLIM PERSONAL LAW – DIVORCE / TRIPLE TALAQ
  {
    ...
    keywords: {
      ...
      strong: ['muslim divorce','triple talaq','talaq','nikah','mehr','mahr','iddat','khula','zihar','mubarat','faskh','qazi','muslim marriage','shariat','masjid','mosque','halala','nikah halala','muslim woman rights','darul qaza','personal law board','all india muslim personal law board','married a second wife','husband married second wife','married second wife without consent','second wife muslim husband','polygamy muslim','husband second wife','muslim husband second wife','dusri shaadi','second marriage muslim'],
  ...
  // MOTOR ACCIDENT
  {
    ...
    keywords: {
      ...
      strong: ['accident','road accident','vehicle accident','compensation','injury','fracture','insurance claim','motor vehicle','mact','tribunal','death in accident','disability','permanent disability','medical expenses accident','hit and run','drunk driver','negligent driving',
        'riding my bike','riding my scooter','riding a motorcycle','was riding','hit by a car','hit by a bus','hit by a truck','hit by vehicle','knocked down by vehicle','struck by vehicle','knocked by car','car hit me','vehicle hit me','knocked me down','jumped divider','jumped the divider','divider jumped car','ran over me','ran a red light and hit','rash driving hit','i was walking footpath','walking on footpath hit','hit while walking','pedestrian hit','hit from behind','car hit from behind','rear end collision','was hit while cycling','cyclist hit by car','driver fled','driver ran away','driver absconded','fled after hitting','driver fled after hitting me','vehicle with another state registration hit','another state vehicle hit','vehicle fled after accident'],
      weak: ['accident','injured','vehicle','car','bus','truck','bike','road','hit','compensation','insurance','hospital','riding','walking','pedestrian','rear end','divider','collision','knocked']
    },
  ...
  // FAMILY – MUSLIM MAINTENANCE (MWPA / IDDAT / MAHR)
  {
    ...
    keywords: {
      exact: ['muslim wife maintenance','mahr not paid','iddat maintenance','mwpa','muslim women protection act','muslim divorcee maintenance','talaq ke baad kharcha','mahr recovery','shah bano','shah bano case maintenance','muslim divorced woman maintenance rights','muslim divorced woman rights','supreme court muslim maintenance','fair and reasonable provision','danial latifi maintenance','muslim divorcee maintenance rights','mwpa maintenance claim',
        'mehr not paid','mehr amount not paid','nikahnama mehr','husband never paid mehr','mehr mentioned in nikahnama','unpaid mahr nikahnama','nikahnama amount not paid','how much maintenance muslim divorced wife','muslim divorce wife obligation maintenance','obligation to pay maintenance after divorce','muslim husband maintenance obligation'],
      strong: ['mwpa','muslim women act','iddat','mahr','mehr','nikah maintenance','muslim husband refusing maintenance','danial latifi','talaqshuda','muslim divorcee','shah bano','muslim divorced woman','fair provision muslim','divorced muslim woman','muslim maintenance rights','muslim women maintenance','nikahnama','mehr unpaid','obligation to maintain muslim wife','muslim wife entitled to maintenance','how much maintenance muslim divorced wife','maintenance amount entitled muslim divorced wife','obligation to pay maintenance muslim','muslim divorced wife maintenance entitlement','muslim husband married second wife','married second wife without consent','polygamy without consent','husband second wife without consent','muslim second marriage'],
      weak: ['muslim','maintenance','alimony','divorce','husband','wife','mehr','mahr','iddat','nikah','nikahnama']
    },
    sections: [],
    documents: [
...

  {
    ...
    salaryThresholds: {
      epf: { limit: 15000, note: 'EPF mandatory for employees earning up to ₹15,000/month (basic+DA). Earning above ₹15,000? You can voluntarily contribute but employer cannot be compelled.' },
      esi: { limit: 21000, note: 'ESI covers employees earning up to ₹21,000/month gross (₹25,000 for persons with disability). Above this limit, ESI does not apply.' },
      irc_worker: { limit: 18000, note: 'Industrial Relations Code 2020 – supervisors earning above ₹18,000/month may be excluded from the definition of "worker," limiting access to Labour Court remedies. Non-supervisory employees have no salary cap.' },
      code_on_wages: { limit: null, note: 'Code on Wages 2019 applies to ALL employees regardless of salary — no upper limit.' }
    },
    quickTip: 'SALARY THRESHOLDS: EPF mandatory ≤ ₹15,000/month basic; ESI applies ≤ ₹21,000/month gross; supervisors earning > ₹18,000/month may fall outside "worker" definition under Industrial Relations Code 2020 — verify before filing in Labour Court. Code on Wages applies to ALL employees (no cap). An employee dismissed without proper notice or inquiry can challenge it before the Labour Court. The employer must prove valid cause. Reinstatement + back wages is the most common remedy.',
    keywords: {
      ...
      strong: ['terminated','dismissal','wrongful termination','unfair dismissal','employer','notice period','full and final','retrenchment','labour court','industrial dispute act','workman','employee rights','salary unpaid','wages not paid','unpaid wages','pending salary','back wages','overtime not paid','bonus not paid','provident fund','service record','appointment letter','offer letter','resignation accepted','employment contract','contract labour','contractor employee','relieving letter','experience letter','no-dues certificate','gig worker','platform deactivated','app worker','delivery worker','employee performance','terminate employee','forced to resign','forced me to resign','manager forced resign','boss forced resign','threatened false charges resign','forced resignation manager','employer forced resignation','boss threatened false charges','manager threatened me to resign','transferred as punishment','punitive transfer','swiggy delivery partner','zomato delivery partner','uber driver rights','delivery partner employee','app delivery partner denied benefits','platform worker denied benefits','delivery partner treated as employee'],
      weak: ['fired','dismissed','job','employer','employee','salary','wages','hr department','boss fired','termination letter','notice period','last working day','full and final settlement','dues unpaid','arrears','increment denied','appraisal dispute','job loss','unemployed wrongfully',
        // Hindi job termination
        'naukri se nikaal','naukri se nikaala','naukri se hataya','kaam se nikaal','job se nikaal','nikaal diya','nikaala gaya','nikaala gaya bina','naukri nahi di','notice nahi mila','settlement nahi','force resign','resign karaya','karaya bina settlement','bina notice nikaal','bina settlement nikaal',
        // forced resignation scenarios
        'forced to resign','force me to resign','forced my resignation','manager forced','boss forced me to resign','threatened me with false charges','threatened with false charges','threatened with termination','resign under pressure','resigned under duress','made me resign','coerced to resign','pressured to resign',
        // workplace bullying
        'manager bullies','boss bullies','manager abusive','boss abusive','abusive language daily','uses abusive language','abuses me at work','workplace bullying','bullied at work','verbal abuse at workplace','manager uses abusive','standing orders','procedure not followed termination']
    },
    sections: ['Industrial Relations Code 2020 – Sec 77 (Retrenchment compensation, replaces ID Act Sec 25-F)','Industrial Relations Code 2020 – Sec 79 (Prior permission for retrenchment, replaces Sec 25-N)','Industrial Relations Code 2020 – Sec 53 (Reference to Labour Court, replaces Sec 10)','Code on Wages 2019 – Sec 12 (Timely payment of wages)','Code on Wages 2019 – Sec 6 (Minimum wages)','Shops & Establishments Act (state-specific)','Code on Social Security 2020 – Sec 15 (EPF non-deposit penalty)','Code on Social Security 2020 – Sec 53 (Gratuity payment)'],
    documents: [
    ...
    probingQuestions: [
      { q: 'What is your monthly gross salary (approx.)?', tip: 'SALARY DETERMINES WHICH LAWS APPLY: EPF mandatory ≤ ₹15,000/month (basic+DA); ESI applies ≤ ₹21,000/month gross; supervisors earning > ₹18,000/month may fall outside the "worker" definition under Industrial Relations Code 2020 and may need to approach Civil Court instead of Labour Court. Code on Wages applies to ALL employees regardless of salary.' },
...

  {
    ...
    keywords: {
      ...
      strong: ['posh','sexual harassment','workplace harassment','internal complaint committee','icc','she committee','unwanted advances','inappropriate touching','lewd remarks','hostile work environment','quid pro quo','sexual favor','sexual misconduct','sexual gesture','office harassment',
        'harassed by boss','boss harassed me','boss sexually harassed','boss harassed and fired','fired after complaining about harassment','fired after sexual harassment complaint','terminated after posh complaint','retaliated against for harassment complaint','complaint against boss harassment','reported harassment and got fired','harassment complaint retaliation','fired after reporting boss'],
  ...
  // FAMILY – SPECIAL MARRIAGE ACT (COURT MARRIAGE)
  {
    ...
    keywords: {
      exact: ['special marriage act','court marriage','civil marriage divorce','sma 27','sma 28','sma mutual','inter-religious marriage','love marriage court','registered marriage divorce','marriage officer','hindu girl marrying muslim boy','hindu girl marrying muslim','muslim boy marrying hindu girl','different religion marriage registration','inter-religion marriage registration','inter-caste marriage registration','hindu muslim marriage registration','what law for inter-religion marriage','what law applies for inter-religion','marriage between different religions'],
      strong: ['special marriage act','court marriage','civil marriage','marriage officer','30-day notice','inter-faith marriage','inter-religious marriage','love marriage','registrar marriage',
        'hindu girl marrying muslim','muslim boy hindu girl','different religion marriage registration','inter-caste marriage registration','what law for inter-religion marriage','hindu muslim marriage','inter religion marriage registration','marriage between different religions','register inter religion marriage'],
  ...
  // FAMILY – SENIOR CITIZENS MAINTENANCE & WELFARE
  {
    ...
    keywords: {
      ...
      strong: ['senior citizens act','parents maintenance','maintenance tribunal','gift cancellation','sec 23 sr citizens','abandonment','neglected parent','sdm tribunal','gift deed cancellation','gift deed cancelled','transfer property parent neglected','gift deed senior','elderly parents property','senior citizen gift deed','reverse gift deed','senior citizen property transferred','gift deed revocation senior','gift deed harassing','son is harassing','son harassing parents','parents harassed by son','children harassing parents',
        'children not taking care','children not caring for me','not taking care of me','my children ignore me','children ignoring elderly parent','old age ignored by children','daughter refuses to maintain','son refuses to maintain','widower maintenance','widower old age','not caring despite property transfer','took property not caring','kicked me out old age','threw me out of house','son threw out of house','son threw me out','threw me out of home','children not supporting old age parent','old person children not caring','75 years old kicked out','80 years old maintenance','daughter evicting father','evicting old parents','old mother evicted','old father evicted',
        'son took my property','took my property now ignores me','took property saying will take care','son took property not caring','took property now abandoned',
        '75 years old children kicked','children kicked me out','kicked me out how to get maintenance','75 year old kicked out',
        'daughter-in-law trying to evict','daughter-in-law is trying to evict','daughter in law evicting me','daughter in law is trying to evict','daughter-in-law evict me','bahu evict','daughter in law wants to evict'],
      weak: ['senior','parents','old age','mother','father','elderly','neglect','thrown out of house','son threw','threw me out','70 years','65 years','60 years','75 years','80 years','old person','aged parent','parent maintenance','maintenance from son','maintenance from daughter','son not giving','children not giving','evicted by son','evicted by children','son evicted','old age home','not taking care','not caring','ignore me','ignoring me','widower','children ignore',
        // Hindi senior citizen keywords
        'saal ka hoon','70 saal','75 saal','80 saal','65 saal','budhapa','bujurg','bete nahi karte','bete nahi','dekh bhal nahi','dekh bhal nahi karte','meri dekh bhal','ghar se nikaal','ghar se nikaalna','beta nikaal raha','nikaalna chahta hai','bete ne ghar se','beta ghar se nikaalna','mujhe ghar se nikaal','mujhe nikaalna','aur mujhe nikaalna']
    },
    sections: [],
    documents: [
  ...
  // CRIMINAL – PMLA (MONEY LAUNDERING)
  {
    ...
    keywords: {
      ...
      weak: ['laundering','money trail','benami','attachment order','financial crime','economic offence','tax evasion arrest','hawala operator','ED notice','enforcement directorate notice','money laundering notice','alleged money laundering','ED has issued','ED investigation','ED summons received']
    },
    sections: [],
    documents: [
  ...
  // CIVIL – IBC (INSOLVENCY & BANKRUPTCY)
  {
    ...
    keywords: {
      ...
      strong: ['ibc','insolvency','corporate insolvency','cirp','nclt','financial creditor','operational creditor','resolution professional','moratorium','liquidation','resolution plan','sec 7','sec 9','sec 10',
        'personal guarantor','personal guarantor insolvency','bank filed insolvency','company filed insolvency','company in insolvency','insolvency proceedings','pending lawsuits insolvency','moratorium on lawsuits','stay on suits insolvency','what happens to cases insolvency','bankruptcy individual','personal insolvency','personal bankruptcy india'],
  ...
  // CYBER – DPDP ACT (DATA PRIVACY)
  {
    ...
    keywords: {
      exact: ['data breach complaint','personal data leaked','data privacy violation','dpdp act case','data fiduciary breach','consent not taken','data not deleted','children data leak','data principal rights','data protection board','medical records leaked by hospital','medical records leaked by hospital to insurance','hospital leaked my medical records','my medical records were leaked by hospital','medical records leaked to insurance','medical records leaked to insurance company','hospital leaked medical records','medical records shared without consent','health records leaked','medical data leaked hospital','records leaked without consent hospital'],
      strong: ['dpdp','digital personal data protection act','data fiduciary','data principal','data breach','consent','privacy policy','data protection board','significant data fiduciary','personal data',
        'employer monitoring','employer tracking','employer surveillance','monitoring personal device','tracking personal phone','company monitoring personal','accessing private data','monitoring without consent','employee surveillance','monitoring calls','tracking location without consent','monitoring whatsapp','monitoring personal messages','data collected without consent','consent not taken for data','data used without consent','profiling without consent'],
  ...
  // CIVIL – COMPANIES ACT / NCLT (CORPORATE)
  {
    ...
    keywords: {
      ...
      strong: ['companies act 2013','sec 241','sec 242','sec 244','sec 248','sec 271','nclt','nclat','registrar of companies','sfio','oppression','mismanagement','minority shareholder','private placement','related party','merger','scheme of arrangement','derivative suit','siphoning','promoter fraud','sebi listed company','corporate restructuring',
        'director dispute','directors dispute','dispute between directors','company director management dispute','private company director dispute','annual report not shared','accounts not shared shareholders','audit report not shared','company directors dispute management','management dispute company'],
  ...
  // CRIMINAL – PREVENTION OF CORRUPTION (BRIBERY)
  {
    ...
    keywords: {
      ...
      weak: ['bribe','corruption','officer','government','acb','cbi','trap','sarkari','rishwat','rishwat maang','patwari rishwat','ghoos','ghoos maang','rishwat maang raha']
    },
    sections: [],
    documents: [
    ...
    contextualQuestions: ['civil'],
    limitation: 'FIR/ACB complaint immediate; trial within 2 yrs target; BNSS Sec 218 / PCA Sec 19 prior sanction',
    urgency: 'High',
    multiLawCompatible: []
  },
  // CIVIL – NGT / ENVIRONMENT / POLLUTION
  {
    ...
    keywords: {
      ...
      strong: ['ngt','national green tribunal','pollution','pcb','cpcb','spcb','eia','environment protection','air pollution','water pollution','noise pollution','crz','forest clearance','environmental damage','biodiversity','toxic waste','chemical waste','industrial waste','factory waste','toxic effluent','industrial effluent','polluting river','polluting water','releasing waste','waste into river','factory releasing','factory dumping','factory smoke','hazardous waste','groundwater contamination','wetland','wetland destruction','destroying wetland','wetland illegal construction','real estate destroying wetland','developer destroying wetland','dj at midnight','midnight noise','dj setup noise','music system midnight','loud music midnight','noise at midnight','dj party noise','midnight loud music','causing disturbance midnight'],
  ...
  // LIVELIHOOD – STREET VENDORS ACT
  {
    ...
    keywords: {
      ...
      strong: ['street vendors act','tvc','town vending committee','vending zone','no-vending zone','hawker rights','vendor survey','sec 3','sec 27','olga tellis','right to livelihood','article 21','vending license','bmc removed cart','vending license valid but removed','vendor cart removed','illegally removed cart','municipal removed vendor','license valid removed','hawker license removed','municipal corporation evicted vendor'],
  ...
  // HEALTHCARE – MTP / PCPNDT (REPRODUCTIVE RIGHTS)
  {
    ...
    keywords: {
      ...
      strong: ['mtp act','medical termination of pregnancy','abortion','gestational age','20 weeks','24 weeks','pcpndt','sex determination','sex selection','ultrasound clinic','rmp','form c','form f','want to terminate pregnancy','terminate due to foetal abnormality','terminate due to fetal abnormality','22 weeks terminate','want abortion','pregnant and want to terminate','pregnancy termination rights','foetal abnormality terminate','clinical trial without consent','drug trial without informed consent'],
  ...
  // ── CONSUMER – COPRA / CONSUMER FORUM ──────────────────────────────────────
  {
    ...
    keywords: {
      ...
      strong: ['consumer','refund denied','replacement refused','poor service','defective product','service deficiency','goods defective','misleading','advertisement false','unfair','consumer rights','consumer grievance','product not as described','warranty denied','warranty rejected','manufacturer defect','manufacturing defect','refuses to replace','product stopped working','stopped working after','product malfunction','defective mobile','defective phone','defective appliance','defective tv','defective laptop','seller refusing','company not responding','service complaint','product complaint','quality complaint','overcharging','hidden charges','fee refund','money not returned','commission complaint','car defect','vehicle defect','defect in car','defect in vehicle','car has defects','vehicle has defects','defects in car','defects in vehicle','defective car','defective vehicle','not replacing under warranty','warranty not honored','warranty claim rejected','warranty not being honored','dealer not replacing','dealer refusing replacement','car under warranty','vehicle under warranty','not honoring warranty','product has defects','defects in product','defect in product','has a defect','product defective',
        // Online shopping
        'ordered online','received empty box','empty box received','received wrong product','received fake product','delivered fake','amazon refund','flipkart refund','meesho','myntra','snapdeal','online order not delivered','online purchase complaint','ecommerce refund','received damaged product','item not as described','received counterfeit','received broken',
        // Gym/membership
        'gym closed','gym membership refund','gym membership cancelled','membership fee refund','club membership','gym shut down','fitness centre closed','spa refund','subscription cancelled without refund',
        // Travel/hotel/services
        'travel agency cheated','hotel overbooking','hotel refused check-in','hotel not as advertised','travel package not delivered','tour operator cheated','holiday package fraud','flight refund','airline refund','ticket refund','hotel booking cancelled',
        // Driving/coaching/services
        'driving school','coaching institute refund','course refund','institute closed','edtech refund','online course not provided','platform removed content',
        // Advocate deficiency
        'advocate negligence','lawyer negligence consumer','solicitor cheated','advocate fees returned','advocate did not appear',
        // Bank/financial
        'bank unauthorized charge','bank hidden charge','bank overcharged','EMI wrongly deducted','bank fee unfair','processing fee refund bank','bank charged without informing','bank fees without notice','bank maintenance fee','bank charged maintenance fee','unnecessary bank fee','bank charged unnecessarily','bank charged fees without consent','bank deducted without consent','bank unauthorized deduction',
        // Matrimonial site fraud
        'matrimonial website fake','matrimonial site fake profiles','fake profiles matrimonial','matrimonial site cheated','marriage site fake','shaadi.com fraud','jeevansathi fraud','matrimony site cheated',
        // Hindi consumer keywords
        'kharab maal','kharab product','wapas nahi le raha','refund nahi de raha','product kharab','maal kharab','company wapas nahi',
        // Hindi appliance / product failures
        'AC kharida','fridge kharida','TV kharida','mobile kharida','phone kharida','kharida jo kharab','kharida jo chalu nahi','chalu nahi hua','chalu hi nahi','band ho gaya','kaam nahi kar raha','replace nahi kar rahi','replace nahi kar raha','company ne replace nahi','company replace nahi','wapas nahi le rahi','warranty ke andar kharab','warranty mein kharab','kharab ho gaya','kharab nikla','nikla kharab','ghalat nikla'],
      weak: ['complaint','product','service','company','buy','purchase','damaged','broken','fake','wrong','cheat','fraud','refund','money','customer','bought','seller','warranty','defect','defects','dealer','replace','replacement','ordered','delivered','received','amazon','flipkart','online','gym','membership','hotel','booking','travel','tour','course','institute','subscription','fee','charge']
    },
  ...
  // ── TAX – INCOME TAX / DIRECT TAX ──────────────────────────────────────────
  {
    ...
    lawCategory: 'Tax',
    actName: 'Income Tax Act, 1961 – Assessment, Appeal, Penalty (incl. Faceless Assessment Sec 144B & New Tax Regime Sec 115BAC)',
    quickTip: 'Respond to any IT notice within the deadline (faceless proceedings are now default under Sec 144B). File an appeal before CIT(A) within 30 days of the assessment order. The new tax regime (Sec 115BAC) is default from AY 2024-25.',
    keywords: {
      ...
      strong: ['income tax','IT notice','tax demand','tax scrutiny','TDS','tax deducted','tax refund','income tax return','ITR','capital gains','LTCG','STCG','assessment','reassessment','penalty income tax','search seizure','tax raid','benami','black money','undisclosed income','CIT(A)','income tax appellate tribunal','income tax tribunal','ITAT appeal','tax evasion','wealth tax','advance tax','self-assessment tax','26AS','form 16','tax officer','AO assessing officer','CBDT',
        'demand notice for tax','tax demand notice already paid','demand notice tax paid','professional tax','professional tax assessment','professional tax department','state professional tax','professional tax wrongly assessed'],
    ...
    sections: ['IT Act Sec 143 (Assessment)','IT Act Sec 144B (Faceless Assessment – mandatory since 2021)','IT Act Sec 147/148 (Reassessment – amended Finance Act 2021)','IT Act Sec 156 (Notice of Demand)','IT Act Sec 246A (Appeal to CIT(A))','IT Act Sec 253 (Appeal to ITAT)','IT Act Sec 271(1)(c) (Penalty for Concealment)','IT Act Sec 132 (Search & Seizure)','IT Act Sec 115BAC (New Tax Regime – default from AY 2024-25)','Benami Transactions (Prohibition) Act 2016'],
    documents: [
  ...
  // ── HEALTHCARE – MEDICAL NEGLIGENCE ────────────────────────────────────────
  {
    ...
    keywords: {
      ...
      strong: ['medical negligence','doctor negligent','hospital error','surgical mistake','wrong operation','misdiagnosis','delayed treatment','treatment error','medication error','prescription error','anesthesia complication','complications post-surgery','patient harmed','doctor mistake','medical council','clinical establishment','negligence compensation','medical malpractice','MCI complaint','death by negligence','wrong diagnosis','lab report wrong','pathology error','blood transfusion wrong','cerebral palsy','birth injury','negligence during delivery','born with disability due to negligence','medical records leaked','health data leaked','hospital data leak','records shared without consent','medical records shared with insurance','leaked medical records hospital','clinical trial without consent','drug trial without informed consent','included in drug trial without consent','included in trial without consent','drug trial without proper informed consent','included in drug trial without proper consent','drug trial proper consent',
        // ICU / caesarean / discharge
        'patient in ICU','ICU not attended','not attended in ICU','ICU negligence','patient died in ICU','ICU patient ignored','hospital not monitoring ICU','caesarean discharge','discharged after caesarean','discharged too early after surgery','premature discharge hospital','early discharge complication','6 hours after caesarean','hours after delivery discharged','hospital discharged early','maternity negligence','delivery negligence','hospital negligence delivery','she almost died hospital','complication after hospital discharge','hospital ignored patient'],
      weak: ['doctor','hospital','surgery','operation','treatment','medicine','patient','medical','health','clinic','nursing home','specialist','diagnosis','report','test','prescription','discharge','admission','ICU','caesarean','caesarian','delivery','died after hospital','almost died','hospital negligent']
    },
  ...
  // ── INSURANCE – CLAIM DISPUTE ───────────────────────────────────────────────
  {
    ...
    keywords: {
      ...
      strong: ['insurance claim','claim rejected','claim denied','insurance dispute','insurer refusing','cashless denied','insurance company','health insurance','life insurance','lic claim','mediclaim','claim settlement','insurance ombudsman','irda','death benefit','sum assured','premium paid','policy lapse','surrender value','maturity amount','exclusion clause','pre-existing condition','waiting period','insurance fraud','insurance grievance','claim delay','endowment plan','endowment policy','endowment plan matured','plan matured not paying','insurance plan matured','lic plan matured','endowment maturity'],
  ...
  // ── EMPLOYMENT – SERVICE LAW / GOVT EMPLOYEE ────────────────────────────────
  {
    ...
    keywords: {
      ...
      strong: ['civil servant','service matter','departmental inquiry','suspension order','dismissal order','promotion denied','seniority dispute','service tribunal','CAT tribunal','administrative tribunal','government job permanent','public servant service','civil services','IAS IPS','IAS IPS IFS','state service','central service','pension','gratuity government','transfer order','transfer policy','posting dispute','regularization','contract employee government','PSU','public sector','HRA arrears','service arrears','compulsory retirement','retrenchment government','military court martial','armed forces','service record','pay scale','grade pay','transferred as punishment','punitive transfer','transferred for raising issues','transferred to remote area punishment','victimization transfer','transfer punitive','hostile transfer',
        'show cause notice','show cause notice government','government show cause notice','received show cause notice','chargesheet government','government departmental','promotion in government job','government job promotion denied','government promotion denied','government job unfair','government employee promotion','departmental action','government department action','back wages government','suspended and acquitted','wrongful suspension government','government employee dismissed','inquiry pending government'],
      weak: ['government','job','service','official','officer','employee','work','dismissed','suspended','transferred','posted','promoted','salary','pension','retirement','department','ministry',
        'show cause','government notice','government job','government department','promotion unfair','back wages','government order']
    },
  ...
  // ── CRIMINAL – POCSO ────────────────────────────────────────────────────────
  {
    ...
    keywords: {
      ...
      strong: ['POCSO','child sexual','minor victim','sexual abuse child','molestation','child pornography','child exploitation','underage','below 18 years','juvenile victim','abuse of minor','sexual assault minor','indecent assault child','child welfare','CWC child welfare committee','special court POCSO','mandatory reporting','POCSO arrest','POCSO FIR','age of consent','sexual harassment minor','online predator','grooming','sexting','child trafficking','POCSO accused defence',
        'bete ke saath galat harkat','school mein bachche ke saath galat','bachche ke saath galat harkat','8 saal ke bete ke saath galat','teacher ne bachche ke saath galat harkat','bacha chhed','chhed chhad bacche ke saath','human trafficking','maid trafficked','trafficked from another state','placement agency trafficking','trafficking placement agency'],
  ...
  // ── CIVIL – BANKING / NBFC / LOAN DISPUTE ──────────────────────────────────
  {
    ...
    keywords: {
      exact: ['bank dispute','banking complaint','bank not paying','unauthorized bank transaction','bank fraud','ATM fraud','net banking fraud','credit card fraud','bank account hacked','loan harassment','recovery agent threatening','recovery agent abusing','NBFC complaint','microfinance harassment','bank EMI deducted twice','bank double debit','bank overcharging','CIBIL score wrong','credit score error','credit card dispute','bank loan problem',
        'nbfc took my vehicle','nbfc people came to my house','nbfc people came to house forcefully','nbfc came to my house forcefully','nbfc came forcefully took vehicle','nbfc people came forcefully','nbfc came forcefully and took vehicle','recovery agent seized vehicle','nbfc seized vehicle','nbfc vehicle taken without notice','nbfc forcefully took vehicle','nbfc recovery agent forceful','bank charged unnecessary fees','bank charged fees without consent','bank unauthorized fee',
  ...
  // ── AGRICULTURE – FARMER RIGHTS ─────────────────────────────────────────────
  {
    ...
    keywords: {
      ...
      strong: ['farmer','kisan','agricultural','farmland','crop','cultivation','harvest','irrigation','soil','seed','fertilizer','pesticide','agri loan','crop damage','crop loss','land revenue','mutation','khatauni','khatian','bhoomi record','7-12','fard','patwari','revenue tribunal','tehsildar','agricultural insurance','crop insurance','farm income','PM kisan','kisan scheme','agricultural subsidy','farming rights','tenancy rights','rent free land','patta land','canal water','canal water diverted','irrigation water diverted','farm water supply','government canal water','forest land generations','forest dwelling tribal','tribal community forest land','van adhikar','forest rights act','traditional forest dwellers','land ceiling','ceiling limit land','exceeds ceiling limit','land exceeds ceiling','land ceiling act','gram panchayat ceiling','panchayat land ceiling','land distribution panchayat','ceiling land claim','ceiling limit exceeded','forest land act','falls under forest','forest act land','government forest land','ancestral land forest'],
  ...
  // ── CONSUMER – FOOD SAFETY / FSSAI ─────────────────────────────────────────
  {
    ...
    keywords: {
      ...
      strong: ['FSSAI','food safety','food adulteration','food contamination','food poisoning','unhygienic food','expired product','food quality','food label','misbranded food','food standards','food license','food business operator','food inspector','food testing','adulterate','substandard food','packaged food','food complaint','restaurant hygiene','kitchen hygiene','food authority','safe food',
        'flies in restaurant','rodents in restaurant','cockroaches in kitchen','insects in food','flies and rodents','unhygienic restaurant','dirty kitchen restaurant','restaurant kitchen complaint','restaurant pest','pest in restaurant kitchen','pest infestation restaurant','filthy kitchen','dirty food','food not safe','food unsafe','artificial color food','artificial colours food','food grade','non food grade','adulterated spices','spice adulteration','adulterated food products','substandard spices','fake spices','color in food','harmful color food'],
  ...
  // ── CRIMINAL / CIVIL – DEFAMATION ───────────────────────────────────────────
  {
    ...
    keywords: {
      ...
      weak: ['false','statement','rumour','lie','fake','news','reputation','honour','dignity','publish','post','spread','say','write','social media','internet','YouTube','WhatsApp','newspaper',
        'civil suit damages','damages for defamation','suit for defamation','defamatory publications','defamatory article','defamatory post','defamatory content','edited screenshot','screenshot circulated','morphed screenshot','edited photo circulated']
    },
  ...
  // ── EMPLOYMENT – MINIMUM WAGES ──────────────────────────────────────────────
  {
    ...
    keywords: {
      ...
      strong: ['minimum wages','payment of wages','salary unpaid','wages held','salary withheld','labour commissioner','wage complaint','below minimum','underpaid wages','wage arrears','wage theft','worker unpaid','labourer unpaid','wages delayed','salary dispute','wage claim','labour authority','minimum wage act','code on wages','labour law wages','daily wages','weekly wages','piece rate wages','contract labour wages','migrant worker wages','apprentice stipend','apprentice not paid stipend','stipend not paid apprentice','apprentice act stipend','equal pay','equal wages','women paid less same work','gender pay gap','equal remuneration','equal pay for equal work','same work different pay','company not paying me','company is not paying','company not paying salary','company not paying money to me','company not paying for months','not paying for 3 months','salary not given months','salary slip not given','salary slips not given','salary slips not provided','refuses to give salary slip','refuses to give salary slips','pf deducted salary slip not given','pf deducted no salary slip'],
  ...
  // ── FAMILY – DOWRY / 498A / STREEDHAN ───────────────────────────────────────
  {
    ...
    keywords: {
      ...
      strong: ['dowry','dahej','498A','streedhan','stridhan','cruelty for dowry','dowry demand','harassment for dowry','in-laws dowry','jewellery return','marriage gifts','dowry death','bride death suspicious','suicide dowry','dowry prohibition','BNS 85','dowry FIR','anti-dowry','false dowry case','defend 498A','dowry extortion','domestic violence dowry',
        'died at in-laws','death at in-laws','sister died suspiciously','bride died','wife died suspiciously','died within 2 years of marriage','suspicious death after marriage','death after marriage in-laws','suspicious death in-laws','died within 7 years','7 years of marriage death','unnatural death after marriage'],
  ...
  // ── PROPERTY – HOUSING SOCIETY / APARTMENT ──────────────────────────────────
  {
    ...
    keywords: {
      ...
      strong: ['housing society','cooperative society','apartment','RWA','residents welfare association','society NOC','maintenance charges','monthly maintenance','society byelaws','society bylaws','AGM','general body meeting','society committee','elected committee','conveyance deed','deemed conveyance','society flat','share certificate','membership society','society dispute','flat owner','apartment owner','common amenities','parking allotment','terrace rights','clubhouse society','noise complaint neighbor','neighbor noise all night','creates noise all night','upstairs neighbor noise','noise at night legal remedy','noise nuisance apartment','nuisance neighbor','neighbor creates noise',
        'society chairman','chairman of society','chairman violating','secretary violating','society secretary','managing committee','society mismanagement','society fraud','society election','society accounts','society transparency','transfer of flat society','society refusing transfer','society flat transfer','bylaws violating','violating bylaws','society bylaws violation','society rules violation','society noise','society parking','society lift','society member rights'],
  ...
  // ── PROPERTY – ADVERSE POSSESSION / EASEMENT ────────────────────────────────
  {
    ...
    keywords: {
      exact: ['adverse possession','hostile possession','squatter rights','12 years possession','possession claim','claim ownership by possession','title by possession','long possession property','easement right','right of way dispute','light and air easement','right of way blocked','access road blocked',
        'living on this land for','been living on land for 25 years','living for 25 years on','25 years possession without disturbance','30 years possession','living without disturbance years','occupied for decades without objection',
        'living on this land for','been living on land for 25 years','living for 25 years','25 years possession','30 years possession','living without disturbance','occupied for decades','possession for 25 years','path through property','water course easement','right to drain','right of passage','permissive easement','prescriptive easement','ancient light easement','easement by necessity','claiming path right','encroachment adverse possession'],
      strong: ['adverse possession','hostile possession','possession 12 years','continuous possession','title by possession','squatter','encroacher possession','trespasser claim','easement','right of way','passage right','access right','light air','prescriptive right','customary right','way leave','drainage right','right to passage','path dispute','road dispute','water right','well right'],
  ...
  // ── CIVIL – MSME / SMALL BUSINESS DISPUTE ───────────────────────────────────
  {
    ...
    keywords: {
      ...
      strong: ['MSME','small business','micro enterprise','small enterprise','medium enterprise','MSME samadhaan','facilitation council','buyer not paying','delayed payment MSME','partnership firm','partnership deed','partner dispute','dissolution of partnership','franchise agreement','distributorship','dealer agreement','supply contract','sub-contractor','commercial dispute','business contract','contract dispute','B2B dispute','invoice unpaid','outstanding payment','commercial court','vesting cliff','co-founder vesting','startup equity dispute','co-founder equity','vesting dispute startup','co-founder quit equity','co-founder claims equity','compound interest delayed payment','msme compound interest','delayed payment interest','buyer not paying msme interest'],
  ...
  {
    caseType: 'Criminal – SC/ST Prevention of Atrocities Act',
    lawCategory: 'Criminal',
    actName: 'Scheduled Castes and Scheduled Tribes (Prevention of Atrocities) Act, 1989 (POA Act) – Sec 3',
    quickTip: 'File FIR directly at the police station — police cannot refuse. If refused, approach the DSP/SP. A special court handles these cases. Bail is restricted for the accused.',
    keywords: {
      exact: ['sc/st atrocity','sc st atrocity','dalit atrocity','caste atrocity','scheduled caste atrocity','scheduled tribe atrocity','prevention of atrocities act','poa act','sc st act','atrocity act','caste based violence','upper caste attacked','upper caste beating','upper caste discrimination','untouchability practiced','untouchability enforced','forced to do manual scavenging','caste slur used','casteist abuse','casteist slur','abused using caste name','insulted for caste','humiliated for being dalit','dalit discrimination','dalit violence','adivasi atrocity','tribal atrocity','bonded labour caste','land grab from dalit','dalit land dispossession','caste discrimination complaint','sc st fir','sc st case','poa complaint','atrocity complaint','dalit rights','jaati ke naam par','jaati ke naam par maar peet','jaati ke naam par gaali','upper caste attack dalit','high caste attacked dalit','brahmin beat dalit'],
      strong: ['sc/st','scheduled caste','scheduled tribe','dalit','adivasi','tribal','untouchability','atrocity','caste violence','caste abuse','caste slur','casteist','discrimination caste','caste based','casteism','caste hatred','manual scavenging','bonded labour','caste oppression','caste atrocity','upper caste','lower caste victimisation','poa act','atrocities act','social boycott caste','caste land dispossession','jaati','bhedbhav jaati','jaati ke naam','dalit beaten','adivasi beaten'],
      weak: ['caste','dalit','tribal','discrimination','harassment','beaten','abuse','slur','untouchable','sc','st','atrocity','jaati','bhedbhav','atyachar']
    },
    sections: ['SC/ST POA Act Sec 3 (Offences)','Sec 3(1)(x) (Verbal insult in public)','Sec 3(2) (Enhanced punishment for public servants)','Sec 14 (Special Court)','Sec 15A (Rights of victims)','IT Act Sec 66A (Online caste abuse)'],
    documents: [
      { name: 'Written Complaint / FIR copy', critical: true },
      { name: 'Witness statements (ideally from same community)', critical: true },
      { name: 'Caste certificate of victim (SC/ST)', critical: true },
      { name: 'Medical report (if physical assault)', critical: false },
      { name: 'Photos / videos of incident', critical: false }
    ],
    probingQuestions: [
      { q: 'What specific act occurred? (Physical attack, verbal abuse, land dispossession, bonded labour?)', tip: 'Each act maps to a specific sub-section of Sec 3 of the POA Act.' },
      { q: 'Is the accused from a non-SC/ST community?', tip: 'The SC/ST Act applies only when the perpetrator is NOT from an SC/ST community.' },
      { q: 'Has an FIR been registered? Did police cooperate?', tip: 'Police cannot refuse an FIR under SC/ST Act. Refusal is itself an offence under Sec 4.' },
      { q: 'Were there witnesses to the incident?', tip: 'Witness testimony, especially from bystanders of any community, significantly strengthens the case.' }
    ],
    contextualQuestions: ['sc_st','criminal'],
    limitation: 'No specific limitation — report promptly',
    urgency: 'high',
    multiLawCompatible: ['Criminal – BNS (Assault / Hurt / Grievous Hurt)','Constitutional – PIL / Writ Petition (High Court / Supreme Court)','Constitutional – Police Excess / Illegal Detention']
  },
  ...
  // ── CONSTITUTIONAL – POLICE EXCESS / ILLEGAL DETENTION ──────────────────────
  {
    ...
    quickTip: 'IMPORTANT: For offences punishable with less than 7 years imprisonment, police CANNOT arrest directly — they MUST first issue a written Notice of Appearance under Section 41A CrPC (now BNSS Section 35). Never go to a police station merely because a police officer called you on the phone — always demand a written Notice of Appearance first. The Supreme Court has confirmed this. For illegal detention, file a Habeas Corpus petition in High Court immediately. File FIR / complaint to Superintendent of Police for custodial violence.',
    keywords: {
      exact: ['notice of appearance from police','section 41A crpc notice','41A notice police','bnss section 35 notice','police called without written notice','police called on phone to come to station','police threatening to arrest without notice','demanded notice of appearance','police asking to come without written notice','phone call from police come to station','verbal summons police station','police telephonically asked to come','police summoning on phone without notice','police said come to station without document','police calling without FIR',
        'police beat','police beating','police beat me','custodial torture','illegal detention by police','police harassment','police custody abuse','unlawful arrest','police arrested without warrant','illegal confinement','detained without FIR','police brutality','fake encounter','police encounter','NHRC complaint','human rights complaint','police excess','false case by police','police planting evidence','police acting for influential person','police threatening','NSA detention','preventive detention','PSA detention','COFEPOSA detention','political detention','police detained my son 48 hours without producing before magistrate','police detained 48 hours without magistrate production','illegal detention habeas corpus police 48 hours','police refusing to register my complaint against a politician','police not registering complaint against politician political interference','political interference law enforcement police complaint politician','police refusing complaint politician political influence',
        'arrested without any FIR','arrested me without any FIR','kept for 3 days without FIR','held for 3 days','held without FIR','kept in custody without charge','detained without charge','no FIR registered and arrested','arrested without reason','arrested without cause','no reason given for arrest','arrested illegally','illegal arrest','section 156 3','section 156(3)','156(3) petition','magistrate petition for FIR','magistrate order FIR','court order police to file FIR','petition under 156 3 for police','magistrate petition under 156','156 3 for police to register','petition for police to register FIR','petition to register FIR police','magistrate petition 156 3','156 3 FIR petition','petition FIR magistrate','to extract confession','torture to extract confession','tortured to confess','police tortured me in custody','police forced confession','extracted confession by police','police shot my son','police killed my son','encounter killing','custodial death','died in police custody','police encounter fake','police tortured in custody','custodial violence','female constable forced to resign','female police constable forced to resign','female police constable was forced to resign','female constable was forced to resign','gender bias in police','police gender discrimination','police shot innocent','innocent killed in encounter','my relative was taken by police','no one knows where he is','taken by police no information','relative taken by police',
      ...
      strong: ['notice of appearance','section 41A','41A notice','written notice police','bnss section 35 notice before arrest','notice before arrest police','phone call police station','verbal summons police','police called on phone','police called without notice',
        'police excess','police brutality','custodial violence','custodial torture','police harassment','illegal detention','unlawful arrest','Article 21','Article 22','fundamental rights violation','arrested without warrant','warrant not shown','rights not informed','lawyer denied','bail denied illegally','lock-up torture','third degree torture','NHRC','human rights','police misconduct','police complaint','encounter killing','fake encounter','encounter death','national security act','preventive detention','detention without trial','lgbtq','lgbtqia','queer','sexual minority','transgender harass','police harassing lgbtq','police extorting lgbtq','police harassing transgender','police harassing gender minority','156(3)','section 156 3','magistrate petition fir','petition to register fir',
        // illegal arrest without FIR
        'arrested without FIR','arrest without FIR','kept in custody without','held without charge','detained without charge','arrested and no FIR','detained without any FIR','no FIR arrest','kept for days without','held for days without','arrested without reason','police shot my','police killed','encounter death','custodial death','died in custody','relative died in custody',
        // gender and service
        'female constable forced to resign','woman police','female officer harassed','gender bias police','forced to resign gender','encounter investigation','fake encounter investigation','innocent killed by police'],
      weak: ['police','arrest','detained','custody','locked','rights','warrant','jail','lock-up','thane','thana','girftar','giraftari','pakda','police station']
    },
    sections: ['BNSS Sec 35 / CrPC Sec 41A (Notice of Appearance – Written notice mandatory before arrest for offences < 7 years; confirmed by Supreme Court)','Constitution Art 21 (Right to Life)','Art 22 (Protection against Detention)','BNSS Sec 35 (Arrest Procedure)','Sec 50 (Rights of Arrested Person)','Habeas Corpus (Art 226 of Constitution)','NHRC Act 1993','National Security Act 1980 (NSA) challenge'],
    documents: [
    ...
    probingQuestions: [
      { q: 'Did police contact you verbally (phone call) or issue a written Notice of Appearance?', tip: 'For offences punishable with less than 7 years, police MUST issue a written Notice of Appearance (Section 41A CrPC / BNSS Sec 35) before making an arrest. A phone call or verbal summons is NOT legally binding — you may decline to attend without a written notice.' },
...
function getContextualQuestions(description) {
  ...
  const detectors = {
    ...
    property: ['property','land','house','flat','plot','tenant','landlord','rent','builder','rera','encroach','boundary','sale deed','transfer','partition','mortgage','neighbor','neighbour','wall','fence','broke my','damaged my','trespass','vandal','broke down'],
    ...
    nri: ['nri','abroad','overseas','oci card','oci holder','fema','foreign exchange','nre','nro','non resident'],
