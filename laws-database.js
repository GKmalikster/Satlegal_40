...
const LAWS_DATABASE = [
...

  {
    ...
    keywords: {
      ...
      strong: ['mutual divorce','both agree','no dispute','settlement agreement','divorce settlement','alimony agreed','custody agreed','cooling period divorce','first motion second motion','living separately one year','separated by agreement'],
...

  {
    ...
    keywords: {
      exact: ['child custody dispute','custody of my child','want custody of children','husband taking away children','wife not letting me see children','visitation rights for child','guardian of child','custody battle','parental rights','access to child denied','child abducted by spouse','overseas child custody'],
      strong: ['custody','child custody','children custody','guardianship','minor child','visitation','visitation rights','access rights','parenting plan','child welfare','best interests of child','physical custody','legal custody','primary caregiver','custody order','custody petition','ward','guardian'],
...

  {
    ...
    keywords: {
      ...
      weak: ['abuse','violence','hurt','fear','safe','scared','beaten','beating','husband','in-laws','home','threat','dowry','unsafe','cruel','live-in','blackmail','financial control','no money household','economic abuse']
    },
...

  {
    ...
    keywords: {
      exact: ['restitution of conjugal rights','judicial separation petition','husband left matrimonial home','wife refusing to come back','spouse not returning home','legal separation without divorce','petition for conjugal rights'],
  ...
  // SUCCESSION LAWS
  {
    ...
    keywords: {
      ...
      strong: ['father died','mother died','husband died','parent died','passed away','no will','without will','died without','ancestral property','ancestral land','grandfather property','grandmother property','family property','joint family','inherited property','huf','hindu undivided family','coparcener','daughter share','daughter rights','legal heir','legal heirs','property distribution','property division after death','share in property','succession','inherit','inheritance','intestate','class i heir','brothers denying','relatives claiming'],
  ...
  // LIVELIHOOD
  {
    ...
    keywords: {
      ...
      weak: ['work','wages','livelihood','government','scheme','denied','panchayat','village','rural','employment','entitlement']
    },
...

  {
    ...
    keywords: {
      ...
      weak: ['arrested','jail','prison','custody','police','case','court','criminal','accused','bail','charge','offence']
    },
  ...
  // PROPERTY
  {
    ...
    keywords: {
      ...
      strong: ['encroachment','encroached','boundary','boundary wall','neighbour dispute','trespassing','illegal construction','unauthorized construction','wall on my property','land grabbing','occupied my land','my land taken','disputed land','survey report','mutation','neighbour','boundary stone','padosi ne zameen','kabza liya','deewar bana li','blocking access road','access road blocked','garden crossing','right of way blocked','padosi building','illegal construction neighbor','light ventilation blocked','politician grabbing land','local politician land grab','agricultural land grabbed muscle'],
...

  {
    ...
    keywords: {
      exact: ['tenant not paying rent','tenant refusing to vacate','evict tenant','landlord not returning deposit','landlord harassing tenant','illegal eviction','rent agreement dispute','security deposit not returned'],
      strong: ['tenant','landlord','eviction','rent arrears','rental agreement','lease agreement','lease violation','vacate','deposit','security deposit','rent not paid','illegal subletting','evict','notice to vacate','tenancy'],
      weak: ['flat','house','apartment','renting','rent','monthly','paying','not paying','not vacating','contract','notice','lease']
    },
  ...
  // ── INTELLECTUAL PROPERTY ─────────────────────────────────────────────────
  {
    ...
    keywords: {
      exact: ['trademark infringement','copyright infringement','patent infringement','someone copied my logo','someone using my brand name','copied my design','stolen my content','pirated my software','trademark registered','copyright registered','patent filed','trademark application','design registered','intellectual property','ip theft'],
      strong: ['trademark','copyright','patent','ip','intellectual property','brand name','logo stolen','design stolen','content copied','piracy','plagiarism','infringement','trade secret','trade mark','registered trademark','copyright violation','passing off','counterfeit','fake products brand','brand protection'],
      weak: ['brand','logo','name','design','content','music','book','software','invention','product','copied','stolen','fake']
    },
  ...
  // ── POCSO / CHILD SEXUAL ABUSE ───────────────────────────────────────────
  {
    ...
    keywords: {
      ...
      strong: ['pocso','child sexual abuse','sexual assault minor','acid attack','acid','child molestation','child rape','minor abused','sexual offence child','child protection','child welfare committee','cwc','juvenile justice','jja','child trafficking','child labour','sexually abused child','pocso act','sexual offence against child'],
      weak: ['child','minor','abuse','sexual','assault','molest','school','teacher','relative','touching','harassment','victim','student']
    },
  ...
  // ── SENIOR CITIZEN / MAINTENANCE OF PARENTS ──────────────────────────────
  {
    ...
    keywords: {
      ...
      weak: ['old','elderly','parent','senior','70 years','75 years','80 years','neglected','son not caring','daughter not caring','children neglecting','property taken son','house eviction elderly']
    },
  ...
  // ── SC/ST ATROCITIES / CASTE DISCRIMINATION ───────────────────────────────
  {
    ...
    keywords: {
      exact: ['my college is discriminating against me on basis of caste','police is harassing members of our sc st community','university professor is discriminating against sc student','my supervisor called me by caste name and humiliated me in front of colleagues','our tribal community has been living on this forest land for generations','police refusing to register sc st atrocity case','sc student scholarship was wrongly denied by state govt','my sc colleague was beaten up by upper caste persons using casteist slurs','sc/st atrocity complaint','sc st discrimination complaint','mere saath jaati ke naam par bhedbhav hua aur gaali di','jaati ke naam par bhedbhav','caste discrimination hindi'],
      strong: ['sc st atrocities','poa act','scheduled caste','scheduled tribe','atrocity act','caste discrimination','casteism','untouchability','caste abuses','dalit rights','tribal rights','adivasi rights','sc st act','sc st fir','atrocity fir','special courts sc st','forest rights tribal','forest rights act','scholarship discrimination','caste harassment'],
      weak: ['caste','sc','st','dalit','tribal','adivasi','untouchability','discrimination caste','casteist','sc st','lower caste','upper caste','scholarship denied','forest land']
    },
  ...
  // ── MATERNITY BENEFITS ACT ────────────────────────────────────────────────
  {
    ...
    keywords: {
      ...
      strong: ['maternity leave','maternity benefit','maternity benefit act','26 weeks maternity','pregnancy leave','maternity pay','nursing break','creche facility maternity','pregnant employee rights','fired during pregnancy','terminated pregnancy','pregnancy discrimination','dismissed pregnant','pregnancy termination employment','ante natal leave','post natal leave'],
      weak: ['maternity','pregnancy','pregnant','nursing mother','creche','breast feeding','antenatal','postnatal','fired while pregnant']
    },
  ...
  // ── ELECTRICITY ACT / UTILITY DISPUTES ────────────────────────────────────
  {
    ...
    keywords: {
      ...
      weak: ['electricity','power','meter','bill','connection','disconnection','electricity board','discom','billing','smart meter','electricity complaint','electricity supply','current','voltage']
    },
