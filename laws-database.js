...
const LAWS_DATABASE = [
  ...
  // HINDU MARRIAGE ACT & DIVORCE
  {
    ...
    keywords: {
      ...
      strong: ['divorce','separation','cruelty','adultery','desertion','impotency','mental cruelty','physical cruelty','matrimonial home','marital discord','broken marriage','failed marriage','divorce petition','respondent spouse','matrimonial','conjugal rights','husband abusive','wife abusive','domestic violence','dowry harassment'],
