...
const LAWS_DATABASE = [
  ...
  // ── SPECIFIC PERFORMANCE / CONTRACT ──────────────────────────────────────
  {
    ...
    keywords: {
      ...
      weak: ['contract','agreement','breach','party','performance','obligation','fulfil','execute','deed','promise','refused','violated','stamp paper','stamp duty','notarized']
    },
