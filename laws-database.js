...
const LAWS_DATABASE = [
...

  {
    ...
    keywords: {
      exact: ['restitution of conjugal rights','judicial separation petition','husband left matrimonial home','wife refusing to come back','wife refuses to come back','spouse not returning home','legal separation without divorce','petition for conjugal rights','wife refuses to return home','wife refuses to come back to matrimonial home'],
      strong: ['judicial separation','conjugal rights','matrimonial home abandoned','refused to cohabit','refusing to live together','withdrawn from society','without reasonable excuse','separated but not divorced','wife refuses to return','wife not coming home','rcr petition'],
  ...
  // IT ACT / CYBER FRAUDS
  {
    ...
    keywords: {
      exact: ['online fraud','cyber fraud','lost money online','cheated online','phishing attack','upi fraud','bank fraud online','otp fraud','job offer online paid registration fee','paid registration fee job offer','paid registration fee they disappeared','job offer paid fee disappeared','mere bank khate se paise nikaale gaye','bank mein fraud hua','fake investment scheme','ponzi scheme online','online scam','crypto fraud','digital payment fraud','sim swapping fraud','vishing call fraud','aadhaar otp misused','money transferred by fraud','i paid for mobile on olx seller blocked me item never came','my sim was fraudulently swapped and all my bank accounts were drained','someone impersonating our ceo by email asked cfo to transfer funds','i got a call saying i won lottery they took fees but no prize came','fake investment app invest karake mere lakh le liye','my email and bank account was hacked someone changed my password','my whatsapp was hacked and used to ask money from all my contacts','i paid money to a consultancy for government job placement it was fraud','fake job agency ne paise le liye job nahi mili','someone used my credit card fraudulently online','i ordered product from a fake website it was not delivered','mere khate se bina meri marzi ke paise nikaale gaye','mere bank account se paise gaye'],
  ...
  // ── NGT / ENVIRONMENTAL VIOLATION ────────────────────────────────────────
  {
    ...
    keywords: {
      ...
      weak: ['pollution','factory smoke','toxic','effluent','river polluted','noise','quarry','brick kiln','environment','ecology','waste','chemical','industrial waste','polluted water','air quality','ngt','dhuan','factory ke paas','factory near house','smoke from factory']
    },
  ...
  // ── DPDP / DIGITAL PRIVACY ───────────────────────────────────────────────
  {
    ...
    keywords: {
      ...
      strong: ['dpdp','digital personal data protection','data privacy','data breach','personal data','data protection','data fiduciary','data principal','consent withdrawal','data erasure','right to correction','meity complaint','data processor','sensitive personal data','sec 43a it act','aadhaar fraud','aadhaar misuse','aadhaar data','biometric data misuse','employee monitoring illegal','workplace surveillance','aadhaar se loan fraud','aadhaar se loan liya','aadhaar se loan le liya','aadhar se loan','aadhaar number misuse','aadhaar se kisi ne loan liya','aadhaar se kisi ne loan le liya','aadhaar without consent loan','meri bina marzi aadhaar use','bina permission aadhaar use','bina permission ke aadhaar','aadhaar bina marzi loan'],
  ...
  // ── SC/ST ATROCITIES / CASTE DISCRIMINATION ───────────────────────────────
  {
    ...
    keywords: {
      ...
      strong: ['sc st atrocities','poa act','scheduled caste','scheduled tribe','atrocity act','caste discrimination','casteism','untouchability','caste abuses','dalit rights','tribal rights','adivasi rights','sc st act','sc st fir','atrocity fir','special courts sc st','forest rights tribal','forest rights act','scholarship discrimination','caste harassment','jati ke naam se gaali','jaat ke naam se gaali','jaati ke naam par gaali','caste name abused','jati pe gaali','caste based humiliation','lower caste discrimination','sc st humiliated','dalit atyachar','dalit par atyachar'],
