...
const LAWS_DATABASE = [
  ...
  // LIVELIHOOD
  {
    ...
    keywords: {
      ...
      strong: ['mgnrega','nrega','job card','livelihood','right to work','minimum wages not paid','government scheme','social security','unemployment allowance','ration','food security','pm awas','street vendor','hawker rights','svs act','vendors act','article 21','constitutional right','panchayat','gram sabha','vending zone','town vending committee','bmc removed cart','hawker license','vending license','pm kisan','PM Kisan scheme','kisan scheme','kisan yojana','PM kisan amount','kisan samman nidhi','ayushman bharat','ayushman card','government benefit denied','scheme benefit denied','ration card wrongly removed'],
...

  {
    ...
    keywords: {
      ...
      strong: ['assault','beaten','attacked','hurt','injury','fracture','grievous hurt','bodily harm','physical attack','violence','battered','acid','burn','stabbed','shot','threat of violence','eve teasing','stalking','following me','life threatening calls','abduction','kidnapping','ransom','watchman beat','dog attack','neighbor dog','acid thrown','mob violence','casteist slur violence','slapped colleague','workplace assault','hit me','punched','kicked','slapped','beat me','beating me','punched me','kicked me','slapped me','neighbor hit','neighbor beat','broke my arm','broken arm','broke my leg','broken leg','broke my nose','broken nose','broke his arm','broke her arm','broke his leg','broke her leg','broke my hand','broke my wrist','broken bone','physical injury','bodily injury','padosi ne mara','mujhe mara padosi ne','naak toot gayi','haath toot gaya','pair toot gaya','mujhe maara','unhone mujhe mara','mujhe maara unhone','bhai ne maar diya','mujhe bhai ne maara','relative hit me','family member hit me','bhai ne maara','school teacher hit child','teacher hit student','teacher physically hit','brick thrown injured','brick hit me','road rage injured','road rage fight','driver fought with me','threatened at gunpoint','gunpoint forced to sign','gun threat to sign','sign document gunpoint',
        'gym trainer assault','trainer assaulted me','trainer beat','human trafficking','anti-human trafficking','trafficking complaint','anti-trafficking','domestic worker enslaved','kept as slave','held as slave','slave labour','maid captive','maid servant captive','domestic worker slave','forced to work no pay','forced labour complaint','worker held captive','domestic worker held','extortion complaint','organized crime extortion','extortion criminal complaint','business extortion','extortion by goons','cab driver misbehaved','cab driver assault','cab driver harassed','Ola Uber driver assault','ride share driver assault','baraatee ne maar diya','shaadi mein assault','wedding assault','wedding fight FIR','bomb threat complaint','hoax threat complaint'],
  ...
  // CIVIL
  {
    ...
    keywords: {
      ...
      strong: ['money recovery','debt recovery','loan recovery','unpaid loan','borrower defaulted','promissory note','money owed','cheque bounced','dishonoured cheque','emi default','principal not returned','guarantor liability','surety','recovery suit','recover money','not repaying','written agreement loan','lent money','friend borrowed','gave loan','repay loan','loan amount','return money','pay back','outstanding amount','money due','project fees not paid','client refusing to pay','professional fees due','overdue payment','delivered goods not paid','msme buyer not paying','invoice overdue','business partner owes','security deposit office not returned','money decree not paid','freelance payment','freelance not paid','freelance project payment','client not paying freelance','payment not released client','payment withheld client','payment due freelance','freelancer payment','client payment not released','loan given to friend','loan given not returned','loan to friend','civil suit money','civil suit loan','loan civil court','civil recovery suit','personal loan civil suit','paisa wapas nahi','paise wapas nahi de raha','dost ne paisa nahi diya','paisa wapas kar','dost ka paise wapas','wapas nahi kar raha paise','money wapas nahi','dost ne paise nahi diye','dost ne paise nahi diye wapas','paise nahi diye wapas','contractor took payment','contractor took advance','contractor took money not doing work','contractor not returning money','contractor payment not refunded','yaar ko paise diye wapas nahi kiye','yaar ne paise nahi diye','dost ko paise diye wapas nahi aaye','2 saal ho gaye paise wapas nahi',
        'execution petition','execute money decree','decree execution','attach salary court order','salary garnishment','salary attachment decree','court order to attach salary','owes me money','someone owes','recover money from','how to recover money from','attachment before judgment','attach property before judgment','property attachment suit','salary garnishment court','demand draft not credited','demand draft payment','money owed limitation','recovery still possible','paisa liya wapas nahi','yaar ne paisa liya wapas nahi'],
  ...
  // ── INTELLECTUAL PROPERTY ─────────────────────────────────────────────────
  {
    ...
    keywords: {
      ...
      strong: ['trademark','copyright','patent','intellectual property','brand name','logo stolen','design stolen','content copied','piracy','plagiarism','infringement','trade secret','trade mark','registered trademark','copyright violation','passing off','counterfeit','fake products brand','brand protection','logo','tagline','tag line','copied my','copying my','brand copied','logo copied','brand infringement','unauthorized use of logo','my design copied','competitor copied','youtube video copied','youtube content stolen','video reposted','reposted without credit','reposted without permission','content reposted','plagiarized','plagiarized content','book plagiarized','plagiarize','author plagiarism','content plagiarism','copyrighted content','using copyrighted content','copyrighted material','YouTube copyright','YouTube using my content','YouTube channel using','software code copied','code stolen','developer copied code','domain name dispute','cybersquatting','domain name cybersquatting','startup name trademark','name already trademarked','name trademark conflict','trademark conflict startup','painting sold without permission','artwork sold without','painting without permission','art copied','art sold without consent','meri painting','online platform removed content','content removed unfairly','platform removed my content','channel content removed unfairly',
        'photograph in advertisement','company used my photograph','my photo in their ad','photo used without permission','using my photograph','royalties to singer','label not paying royalties','music label royalties','royalties not paid','music royalties','royalties dispute','singer royalties','geographical indication','GI tag misuse','Darjeeling tea misuse','GI product misuse','business model copied','business model copy','business model stolen','Google delisting website','app store removed app','app store wrongful removal','Twitter account suspended','Facebook account removed','platform account suspended unfairly','kisi ne mera design copy kiya','business idea stolen'],
  ...
  // ── RAPE / SEXUAL ASSAULT / SEXUAL VIOLENCE (ADULT) ──────────────────────
  {
    ...
    keywords: {
      ...
      strong: [
        ...
        'non consensual sex','without consent','outraging modesty','outrage modesty',
      ...
      weak: [
        'rape','assault','sexual','violated','consent','forced','touched','molested','victim',
  ...
  // ── SC/ST ATROCITIES / CASTE DISCRIMINATION ───────────────────────────────
  {
    ...
    keywords: {
      ...
      strong: ['sc st atrocities','poa act','scheduled caste','scheduled tribe','atrocity act','caste discrimination','casteism','untouchability','caste abuses','dalit rights','tribal rights','adivasi rights','sc st act','sc st fir','atrocity fir','special courts sc st','forest rights tribal','forest rights act','scholarship discrimination','caste harassment','jati ke naam se gaali','jaat ke naam se gaali','jaati ke naam par gaali','caste name abused','jati pe gaali','caste based humiliation','lower caste discrimination','sc st humiliated','dalit atyachar','dalit par atyachar','landlord refused rent sc','rent refused because sc','house not given sc caste','refused rent because of caste','promotion refused caste','caste promotion denied','crop destroyed caste enmity','jati ke naam se dhamki','jati ke naam dhamki gaon se nikaala','gaon se nikaala jati','scholarship denied sc','scholarship denied caste','scholarship denied sc st','dalit attacked','attacked being dalit','attack on dalit','dalit physically attacked','caste slur','caste slurs','abused using caste','abused caste name','caste based attack','violence because of caste','caste violence','beaten because of caste','beaten being dalit','dalit beaten','dalit','atrocity on dalit','dalit abused','because of my caste','because of caste','due to caste','for being dalit','for being sc','attacked for caste','attacked due to caste'],
      weak: ['caste','sc','st','tribal','adivasi','untouchability','discrimination caste','casteist','sc st','lower caste','upper caste','forest land']
    },
