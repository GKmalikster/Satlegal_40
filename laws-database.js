...
const LAWS_DATABASE = [
  ...
  // EMPLOYMENT LAWS
  {
    ...
    keywords: {
      ...
      strong: ['relieving letter','experience certificate not given','noc from employer','full and final settlement','fnf settlement','non-compete clause','non-compete agreement','non compete restriction','restrictive covenant employment','employment contract violation','relieving letter withheld'],
