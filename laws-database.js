...
'blasting cracking walls','mining cracking walls','quarrying causing cracks'],
  ...
  // ── AGRICULTURE / CROP INSURANCE ─────────────────────────────────────────
  {
    ...
    keywords: {
      ...
      weak: ['crop','agriculture','farmer','kisan','zameen','agricultural','flood damage','seed','irrigation','tenancy','farm','harvest loss','zamindar','kheti','fasal','khet','water access','water dispute','irrigation','canal blocked','water canal','kabza zameen','fasal ka muavza','crop compensation','kisan beema','pradhan mantri fasal bima','msp','minimum support price','mandi','anaj','grain storage','land record','khata number','khasra','patwari','tehsil','patta land','sarkari zameen','kisaan','krishi','farming dispute','sharecropper','batai','lagan','tenancy eviction'],
