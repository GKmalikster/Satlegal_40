...
const LAWS_DATABASE = [
  ...
  // MOTOR ACCIDENT
  {
    ...
    keywords: {
      ...
      weak: ['accident','injured','vehicle','car','bus','truck','bike','road','hit','insurance']
    },
